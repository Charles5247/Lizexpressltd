...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@lizexpressltd?is_from_webapp=1&sender_device=pc',
      icon: MessageCircle, // Using MessageCircle as TikTok icon alternative
      color: 'hover:text-black'
    },
    {
      name: 'YouTube',
      url: 'https://youtube.com/@lizexpressltd?si=cpHGI931fS0yNPdc',
      icon: Youtube,
      color: 'hover:text-red-500'
    },
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/profile.php?id=61577030412249',
      icon: Facebook,
      color: 'hover:text-blue-600'
    },
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/lizexpressnig?igsh=MWQ0ZHozeXZkMXU1eA==',
      icon: Instagram,
